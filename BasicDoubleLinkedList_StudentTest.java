...
public class BasicDoubleLinkedList_StudentTest {
    ...
    public Car a = new Car("Toyota", "Camry", 2010);
    public Car b = new Car("Ford", "Escape", 2012);
    public Car c = new Car("Honda", "Accord", 2015);
    public Car d = new Car("Chevrolet", "Malibu", 2018);
    public Car e = new Car("Nissan", "Altima", 2020);
    public Car f = new Car("Tesla", "Model 3", 2022);
